...
ActiveRecord::Schema.define(version: 2021_05_19_051916) do
  ...
  create_table "spina_comments_comments", force: :cascade do |t|
    ...
    t.string "locale"
    t.index ["commentable_type", "commentable_id"], name: "spina_comments_commentable_index"
    t.index ["commenter_type", "commenter_id"], name: "spina_comments_commenter_index"
  end
